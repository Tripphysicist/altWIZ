function [LONobs LATobs TIMEobs HSobs, HSobsSTD, WINDobs, WINDobsSTD, indNaN] = bubbleMethod(obsLon, obsLat, obsTime, obsHs, obsWind, buoyLon, buoyLat, buoyTime,maxDistance,maxTimeDiff,minNumberObs) 
