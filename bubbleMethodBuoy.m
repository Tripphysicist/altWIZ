function [LONobs LATobs TIMEobs HSobs, indNaN] = bubbleMethod(obsLon, obsLat, obsTime, obsHs, buoyLon, buoyLat, buoyTime,maxDistance,maxTimeDiff,minNumberObs) 
...
for i = 1:skipTime:buoyTimeLength
    ...
    if length(meanIndex) >= minNumberObs
        ...
        meanHsByDistance(i) = nanmean(currentData);
